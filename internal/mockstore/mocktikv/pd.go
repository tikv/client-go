...
func (c *pdClient) ListResourceGroups(ctx context.Context, _ ...pd.GetResourceGroupOption) ([]*rmpb.ResourceGroup, error) {
	return nil, nil
}

func (c *pdClient) GetResourceGroup(ctx context.Context, resourceGroupName string, _ ...pd.GetResourceGroupOption) (*rmpb.ResourceGroup, error) {
