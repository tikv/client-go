...
func (m *pdClient) GetServiceDiscovery() servicediscovery.ServiceDiscovery { return nil }

// WithCallerComponent implements the RPCClient interface.
func (m *pdClient) WithCallerComponent(callerComponent caller.Component) pd.RPCClient {
	newClient := *m
