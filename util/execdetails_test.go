...
func TestCommitDetailsMergeReqDetails(t *testing.T) {
	commitDetails := &CommitDetails{}
	commitDetails.MergePrewriteReqDetails(5*time.Millisecond, 10, "store-1", newWriteExecDetailsV2(1, 2, 0, 0, 0, 4, 5))
