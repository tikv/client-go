...
var (
	...
	BoTxnNotFound              = NewConfig("txnNotFound", &metrics.BackoffHistogramTxnNotFound, NewBackoffFnCfg(2, 500, NoJitter), tikverr.ErrResolveLockTimeout)
	...
	BoMaxTsNotSynced           = NewConfig("maxTsNotSynced", &metrics.BackoffHistogramMaxTsNotSynced, NewBackoffFnCfg(2, 500, NoJitter), tikverr.ErrTiKVMaxTimestampNotSynced)
	BoCommitTSLag              = NewConfig("commitTSLag", &metrics.BackoffHistogramCommitTSLag, NewBackoffFnCfg(2, 500, NoJitter), tikverr.ErrCommitTSLag)
	BoMaxRegionNotInitialized  = NewConfig("regionNotInitialized", &metrics.BackoffHistogramRegionNotInitialized, NewBackoffFnCfg(2, 1000, NoJitter), tikverr.ErrRegionNotInitialized)
