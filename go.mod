...
require (
	...
	github.com/tikv/pd v0.0.0-20230313083840-3e3ae55f68ac
...
replace github.com/pingcap/kvproto => github.com/iosmanthus/kvproto v0.0.0-20230330100704-200cdb537fae
