...
require (
	...
	github.com/pingcap/tidb/pkg/parser v0.0.0-20240219094226-fa340f3400aa // indirect
...
replace (
	...
	github.com/pingcap/tidb => github.com/MyonKeminta/tidb v1.1.0-alpha.1.0.20240219090303-2af99d5fa939
